...
5. Create a Node/Express/MongoDB/ReactJS app called `nytreact`. This will be a recreation of the [NYT Articles Search](https://nytarticle-search-fsf.herokuapp.com/) exercise application we built back in Unit 6. Running this application will:
...
* Deploy your application to Heroku once complete. Feel free to use the Ins_Mern activity as a starting point. **You must use Create React App** and current versions of React and React-Router-Dom for this assignment.
